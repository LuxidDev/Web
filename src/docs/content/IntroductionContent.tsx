      ...
      >
        <div className="flex items-start gap-4">
          <div>
            ...
            >
              Luxid is a modern PHP framework designed for developers who care
              about clean architecture, expressive code, and real-world
              performance. It provides a thoughtfully crafted foundation that
              lets you move fast without sacrificing structure, giving you the
              tools to build scalable, maintainable applications with confidence
              and clarity.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
        ...
        >
          ...
          <p className={darkMode ? "text-zinc-400" : "text-zinc-600"}>
            Screen, Entities, Actions - A modern approach that makes your code
            intuitive and organized.
          </p>
          <div className="mt-4 text-sm">
            <strong className={darkMode ? "text-zinc-300" : "text-zinc-700"}>
              Under the Hood:
            </strong>
            <p
              className={`mt-1 ${darkMode ? "text-zinc-500" : "text-zinc-600"}`}
            >
              Luxid's Application class bootstraps everything, managing
        ...
        >
          ...
          <p className={darkMode ? "text-zinc-400" : "text-zinc-600"}>
            Everything you need out of the box: ORM, templating, CLI tools,
          ...
          <div className="mt-4 text-sm">
            ...
            <p
              className={`mt-1 ${darkMode ? "text-zinc-500" : "text-zinc-600"}`}
            >
              Juice CLI uses reflection and file generation to scaffold projects
              quickly.
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              >
                ...
                class instantiates and sets up the environment, loading
                configuration, creating database connection, and starting
                session.
              </p>
              <div className="mt-3">
                <CodeExample
...
$app = new Application(dirname(__DIR__), $config);`}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              >
                <code
                  className={`font-mono px-2 py-1 rounded ${darkMode ? "bg-zinc-800/50 text-green-300" : "bg-green-50 text-green-700"}`}
                >
                  Router
                </code>{" "}
                matches the URL to a registered route, instantiates the Action
                class, and executes middleware.
              </p>
              <div className="mt-3">
                <CodeExample
                  code={`<?php
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p
                className={`text-sm mt-1 ${darkMode ? "text-zinc-400" : "text-zinc-600"}`}
              >
                The Action method runs, interacting with Entities via L ORM,
                processing business logic, and preparing data for the Screen.
              </p>
              <div className="mt-3">
                <CodeExample
                  code={`<?php
    ...
    return $this->nova('posts.show', ['post' => $post]);
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              >
                <code
                  className={`font-mono px-2 py-1 rounded ${darkMode ? "bg-zinc-800/50 text-yellow-300" : "bg-yellow-50 text-yellow-700"}`}
                >
                  Screen
                </code>{" "}
                class renders the Nova template, injecting data and applying the
                frame layout.
              </p>
              <div className="mt-3">
                <CodeExample
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            >
              Luxid leverages PHP 8+ features like attributes, match
              expressions, and typed properties. The framework uses PSR-4
              autoloading and follows modern PHP standards.
            </p>
            <CodeExample
              code={`<?php
    ...
    public function validateEmail() {}
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <code
                className={`px-1 py-0.5 rounded ${darkMode ? "bg-zinc-800 text-green-300" : "bg-green-50 text-green-700"}`}
              >
                DbEntity
              </code>{" "}
              which provides automatic CRUD operations, validation, and
...
$user->delete(); // Soft or hard delete`}
          ...
          <div className="space-y-4">
            ...
            <p
              className={`text-sm ${darkMode ? "text-zinc-400" : "text-zinc-600"}`}
            >
              Comprehensive command-line tools for scaffolding, database
              operations, and project management.
            </p>
            <CodeExample
              code={`# Create a new Luxid project
...
# Visit http://localhost:8000`}
          ...
          <div className="space-y-4">
            ...
            <p
              className={`text-sm ${darkMode ? "text-zinc-400" : "text-zinc-600"}`}
            >
              Blade-inspired templating engine with layouts, components, and
              powerful directives.
            </p>
            <CodeExample
              code={`{{-- Extends layout --}}
...
# Visit http://localhost:8000`}
        ...
        />
        <p
          className={`mt-4 text-sm ${darkMode ? "text-zinc-400" : "text-zinc-600"}`}
        >
          That's it! You now have a running Luxid application. Continue to the
          next chapter to learn more.
        </p>
      </div>
    </>
  );
