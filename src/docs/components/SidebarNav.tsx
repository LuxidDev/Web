...
export default function SidebarNav({
  ...
  return (
    ...
    >
      <h3
        className={`text-lg font-bold mb-6 flex items-center gap-2 ${darkMode ? "text-white" : "text-black"
          }`}
      >
        ...
        {docsChapters.map((section) => (
          <div key={section.id}>
            <div className="flex items-center gap-2 mb-3">
              ...
              />
              <h4
                className={`text-sm font-semibold ${darkMode ? "text-zinc-400" : "text-zinc-600"
                  }`}
              >
                {section.title}
              </h4>
      ...
      {/* Popular Topics */}
      <div
        className={`mt-4 pt-4 border-t ${darkMode ? "border-zinc-800" : "border-zinc-300"
          }`}
      >
        <h4
          className={`text-sm font-semibold mb-2 ${darkMode ? "text-zinc-400" : "text-zinc-600"
            }`}
        >
          Popular Topics
        </h4>
      ...
      {/* Quick Actions */}
      <div
        className={`mt-6 pt-6 border-t ${darkMode ? "border-zinc-800" : "border-zinc-300"
          }`}
      >
        <h4
          className={`text-sm font-semibold mb-3 ${darkMode ? "text-zinc-400" : "text-zinc-600"
            }`}
        >
          Quick Actions
        </h4>
