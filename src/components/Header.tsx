...
import {
  Search, Github, Twitter, MessageCircle, Sun, Moon,
  ...
  return (
    <>
      ...
      <div className={`md:hidden fixed inset-0 z-40 transition-all duration-300 ease-in-out ${
        ...
        {/* Menu Panel */}
        <div className={`absolute right-0 top-0 h-full w-80 max-w-full transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="p-6">
            ...
            >
              ...
              <kbd className={`px-2 py-1 rounded text-xs border ${
                darkMode
                ...
                <p className={`text-xs text-center ${darkMode ? 'text-zinc-500' : 'text-zinc-600'}`}>
                  Created by ~
                    <a
                      ...
                      className={`underline font-semibold transition-colors duration-200 ml-1 ${
